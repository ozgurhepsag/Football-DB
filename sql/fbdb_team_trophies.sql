...
CREATE TABLE `team_trophies` (
  ...
  KEY `fk_trophy_league` (`league`),
  KEY `fk_trophy_team` (`team`),
  CONSTRAINT `fk_trophy_league` FOREIGN KEY (`league`) REFERENCES `league` (`idleague`) ON DELETE CASCADE ON UPDATE CASCADE,
